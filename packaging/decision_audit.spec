...
a = Analysis([str(PROJECT_ROOT / "src/quote_app/__main__.py")],
             ...
             hiddenimports=["PIL.Image", "openpyxl", "tkinter", "quote_app.sites.jd",
...
if sys.platform == "darwin":
    app = BUNDLE(coll, name=APP_NAME + ".app", bundle_identifier="com.fjmobile.quotation.decision-audit")
