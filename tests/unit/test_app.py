...
def test_app_build_label_identifies_honor_search_keyword_scope() -> None:
    from quote_app.app import APP_BUILD_LABEL, BETA_NOTICE

    assert APP_BUILD_LABEL == "荣耀搜索词兼容修复版（仅官网、全部荣耀行）2026.08.01.7"
    assert "搜索词中的品牌前缀和空格" in BETA_NOTICE
