...
Result: collection succeeds; the fixture/provenance and isolated-active-DOM
checks pass and the
...
- All detail fixtures use the public `sku-info > primary (h1.name + summary /
  summary_price) + dl.sku-module.specs` sibling structure, asserted directly
